...
2. 如果 enrichedActivities 为空，activities 的 ticketPriceCny 填 0，openingHours 填 "待查询"，images 填空数组
3. 如果 enrichedWeather 为空，weather 填一个基于目的地和月份的合理估算
4. 如果 enrichedAccommodation 为空，使用 routeSkeleton 中的 accommodation 数据
5. essentialItems 根据目的地和季节给出 5-8 个实用建议
6. 只输出纯 JSON 对象，不要有 markdown 包裹`;
